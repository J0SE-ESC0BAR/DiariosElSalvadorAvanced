...
1. Debe tener el SDK de .NET instalado.
...
Para ejecutar la aplicación, necesita un archivo `credenciales.json` en el directorio raíz del proyecto. Este archivo no se incluye en el repositorio por razones de seguridad (está ignorado en `.gitignore`).
...
Enlace de los diarios en google drive: [Diarios El Salvador](https://drive.google.com/drive/folders/1nlR37RkrI-fDGAtvuFgrToDB9nBrpm1Z?usp=sharing)

## Salidas por consola
```
============================================================
 REPORTE DE DIARIOS OFICIALES DISPONIBLES
============================================================
 Total de diarios encontrados: 31,518
 Años con diarios disponibles: 174
 Período: 1847 - 2025
============================================================
```

## Desarrollador
- **Nombre**: Jose Alfonso Escobar
- **Correo**: [jose@jaem.dev](mailto:jose@jaem.dev)
- **Sitio web**: [jaem.dev](https://jaem.dev)
